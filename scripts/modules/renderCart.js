              ...
              <ul class="modal-cart__props props">
                ...
                <li class="props__item">
                  ...
                  <div class="props__description">
                    <button class="props__btn props__btn__minus" type="button" data-id="${id}">-</button>
                    <output class="prop__count" name="count">${obj.count}</output>
                    <button class="props__btn props__btn__plus" type="button" data-id="${id}">+</button>
                  </div>
                </li>
                <li class="props__item">
